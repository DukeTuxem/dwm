...
static const char col_gray4[]       = "#orange"; // Yellow Marrs Green
static const char col_gray5[]       = "#e56b6f"; // Red Alert for Marrs Green
...
static const char *confirm[]  = { "dmenu_exit", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray2, "-sf", col_gray3, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_q,      spawn,          {.v = confirm } },
	{ MODKEY|ShiftMask,             XK_r,      quit,           {0} },

        /* Favorite apps (using Winkey) */
	{ WINKEY,                       XK_space,  spawn,          SHCMD("keyboard_layout") }, /* ~/.local/bin */
	{ WINKEY,                       XK_f,      spawn,          { .v = browser } },

        /* Function keys */
	{ 0, XF86XK_AudioMute,		spawn,		SHCMD("amixer set Master toggle") },
	{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("amixer set Master 2dB+") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("amixer set Master 2dB-") },
